...
public class LoginForm extends javax.swing.JFrame {
    ...
    public PanelLogin getLoginAndRegister() {
        return loginPanel;
    }
        ...
        TimingTarget target = new TimingTargetAdapter() {
            ...
            public void timingEvent(float fraction) {
                ...
                if (isLogin) {
                    ...
                    if (fraction >= 0.5f) {
                        coverPanel.registerRight(fractionCover * 100);
                    } else {
                    ...
                    if (fraction <= 0.5f) {
                        coverPanel.registerLeft(fraction * 100);
                    } else {
    ...
    private void login() {
        ...
        final Usuario data = loginPanel.getUsuario();
        LoginController.getInstance().logar(data,this);   
    }
