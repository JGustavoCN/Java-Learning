...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        title = new JLabel("Operar Caixa");
        title.setFont(new Font("sansserif", 1, 30));
        title.setForeground(new Color(245, 245, 245));
        add(title);
        description = new JLabel("Para conectar-se só na parte de vendas");
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                title.setText("Administração");
                description.setText("Para conectar-se só na parte administrativa");
                description1.setText("Entre com seus dados pessoais");
                button.setText("ADMINISTRAÇÃO");
            } else {
                title.setText("Operar Caixa");
                description.setText("Para conectar-se só na parte de vendas");
                description1.setText("Entre com seus dados pessoais");
                button.setText("CAIXA");
            }
            this.isLogin = login;
        }
    }
